...
**原文标题：** MMVU: Measuring Expert-Level Multi-Discipline Video Understanding
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.12380) | [arXiv](https://arxiv.org/abs/2501.12380)



---

### 2. Agent-R：通过迭代自训练训练语言模型代理进行反思

**原文标题：** Agent-R: Training Language Model Agents to Reflect via Iterative
  Self-Training
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.11425) | [arXiv](https://arxiv.org/abs/2501.11425)



---

### 3. Condor：通过知识驱动的数据合成与精炼增强大语言模型对齐
...
### 4. Mobile-Agent-E：面向复杂任务的自进化移动助手

**原文标题：** Mobile-Agent-E: Self-Evolving Mobile Assistant for Complex Tasks
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.11733) | [arXiv](https://arxiv.org/abs/2501.11733)



---

### 5. UI-TARS：开创性的自动化GUI交互原生代理

**原文标题：** UI-TARS: Pioneering Automated GUI Interaction with Native Agents
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.12326) | [arXiv](https://arxiv.org/abs/2501.12326)



---

### 6. EMO2：基于末端执行器引导的音频驱动虚拟形象视频生成

**原文标题：** EMO2: End-Effector Guided Audio-Driven Avatar Video Generation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.10687) | [arXiv](https://arxiv.org/abs/2501.10687)
...
**原文标题：** Reasoning Language Models: A Blueprint
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.11223) | [arXiv](https://arxiv.org/abs/2501.11223)
...
**原文标题：** GPS as a Control Signal for Image Generation

**摘要：**
我们证明了照片元数据中包含的GPS标签为图像生成提供了有用的控制信号。我们训练了GPS到图像的模型，并将其用于需要精细理解城市内图像变化的任务。特别是，我们训练了一个扩散模型，以生成基于GPS和文本条件的图像。学习到的模型生成的图像捕捉了不同社区、公园和地标的独特外观。我们还通过分数蒸馏采样从2D GPS到图像模型中提取3D模型，使用GPS条件来约束每个视角下重建的外观。我们的评估表明，我们的GPS条件模型成功地学会了根据位置生成变化的图像，并且GPS条件改善了估计的3D结构。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.12390) | [arXiv](https://arxiv.org/abs/2501.12390)



---

### 9. Hunyuan3D 2.0：面向高分辨率纹理3D资产生成的扩散模型扩展

**原文标题：** Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D
  Assets Generation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.12202) | [arXiv](https://arxiv.org/abs/2501.12202)



---

### 10. 交互学习：现实环境中自适应智能体的数据驱动框架

**原文标题：** Learn-by-interact: A Data-Centric Framework for Self-Adaptive Agents in
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.10893) | [arXiv](https://arxiv.org/abs/2501.10893)



---

### 11. 细节中的魔鬼：在训练专用专家混合模型中实现负载均衡损失的探讨

**原文标题：** Demons in the Detail: On Implementing Load Balancing Loss for Training
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.11873) | [arXiv](https://arxiv.org/abs/2501.11873)



---

### 12. 随流而动：使用实时扭曲噪声实现运动可控的视频扩散模型

**原文标题：** Go-with-the-Flow: Motion-Controllable Video Diffusion Models Using
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.08331) | [arXiv](https://arxiv.org/abs/2501.08331)



---

### 13. 视频深度任意：超长视频的一致性深度估计

**原文标题：** Video Depth Anything: Consistent Depth Estimation for Super-Long Videos
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2501.12375) | [arXiv](https://arxiv.org/abs/2501.12375)
